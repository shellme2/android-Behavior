...
public abstract class ANativeCheckException extends ACheckException implements IReportException{

    private static final String TAG = "ANativeCheckException";
    private static final String FILE_PREFIX = "native--";// 保存的文件前缀
    private static final String FILE_SUFFIX = ".txt";// 保存的文件后缀

    @Override
    public String getExceptionType() {
        return CrashType.TYPE_NATIVE;
    }
    ...
    protected String[] getDropboxTypes() {
        return new String[]{CrashType.DROP_BOX_TYPE_NATIVE_SYSTEM, CrashType.DROP_BOX_TYPE_NATIVE_DATA};
    }
    ...
    public boolean check(Context context) {
        LogUtils.v(TAG, "start check native");
        ...
        // 检查data/system/dropbox/中有没有Native文件
