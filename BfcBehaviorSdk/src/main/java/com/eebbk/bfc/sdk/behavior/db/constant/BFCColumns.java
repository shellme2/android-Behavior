...
public class BFCColumns implements BaseColumns {
     ...
     * 事件属性
     */
    public static final String COLUMN_EA_EVENTNAME = "eventName";
    ...
    public static final String COLUMN_OA_INNER_MODEL = "innerModel";// cpuid
    public static final String COLUMN_OA_ROMVER = "romver"; //机器的MAC地址

    /**
     * 内部使用，不上报服务器
     */
    public static final String COLUMN_INNER_STATE = "state";
